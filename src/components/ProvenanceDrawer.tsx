...
import { X, History, RotateCcw, ChevronDown, ChevronRight, FileCode, Copy, Check } from 'lucide-react';
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
                      ...
                      {!isCurrent && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs font-medium text-[#18181b] dark:text-[#EDEDED] hover:text-black dark:hover:text-white bg-[#f4f4f5] dark:bg-[#1f1f1f] hover:bg-[#e4e4e7] dark:hover:bg-[#282828] border border-[#e4e4e7] dark:border-[#2e2e2e] hover:border-[#a1a1aa] dark:hover:border-[#383838] transition-colors cursor-pointer min-h-[30px] leading-normal"
                          title="Restore and replay this figure state"
                        >
                          <RotateCcw className="w-3 h-3 text-[#71717a] dark:text-[#8C8C8C] shrink-0" />
                          <span>Restore</span>
                        </button>
                      )}
                    </div>
